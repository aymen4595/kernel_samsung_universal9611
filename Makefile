...
export CPP AR NM STRIP OBJCOPY OBJDUMP READELF HOSTLDFLAGS HOST_LOADLIBES LLVM_IAS
...
ifneq ($(ONEUI),)
KBUILD_CFLAGS += -DGRASS_UNIFIED -Wno-error=format -Wno-error=pointer-sign -Wno-error=int-conversion
endif
export ONEUI
...
KBUILD_CFLAGS   += $(call cc-option,-Wno-error=designated-init)
